...
class CommentCategory extends StatefulWidget{
  ...
  CommentCategory({this.data,this.size, this.replyComment,this.updateMyDataToMain, this.myData});
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(widget.myData.myName,style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                          ),
                          Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                              onTap: () async{
                                widget.replyComment([widget.myData.myName,widget.data['commentID']]);
